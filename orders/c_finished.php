...
<table width="100%" border="0">
  <tr valign="top">
    <td><div  style=" float:left;" class="titlehdr"><strong>Completed Orders</strong></div></td>
    <td><div style="float:right;"><?php include 'gmttime.php'; ?></div></td>
  </tr>
</table>
      <?php 
	  $sql_finished = "select * from orders WHERE status ='Fd' and client_id='$_SESSION[id]' ORDER BY order_no DESC";
...
<?php 
	  $orders_done_costs = "select  sum( client_cost ) AS totalcosts  from orders  WHERE status ='Fd' and client_id='$_SESSION[id]'";
