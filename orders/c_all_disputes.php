...
<table width="100%" border="0">
  <tr valign="top">
    <td><div  style=" float:left;" class="titlehdr"><strong>My Disputed  Orders</strong></div></td>
    <td><div style="float:right;"><?php include 'gmttime.php'; ?></div></td>
  </tr>
</table>
      <?php 
	  $sql_assigned = "select * from orders where status='Ds' and client_id='$_SESSION[id]'";
