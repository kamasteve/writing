...
<table width="100%" border="0">
  <tr valign="top">
    <td><span  style=" text-align:center;" class="titlehdr"><strong>Assigned but Unconfirmed Orders</strong> </span> <br><span style="text-align:center; font-size:15px; font-weight:bold;"> Order(s) in progess, only that the writer hasnt confirmed yet. Some writers don't confirm immediately. Not to panic. </span></td>
    <td><div style="float:right;"><?php include 'gmttime.php'; ?></div></td>
  </tr>
</table>
      <?php 
	  $sql_assigned = "select * from orders where status='Cr' and client_id='$_SESSION[id]'";
       ...
       <table  cellpadding="0" cellspacing="0" border="0" class="display" id="thetable">
		<thead>
          <tr> 
            ...
            <th><div align="center"><strong>Assigned To </strong></div></th>
...
echo '<font size="1">Writer ID : '.$row_assigned_to['id'] . '</font>' ; 
			?></div></td>
...
echo $remaining; ?>
            ...
            <td  class="order_borders"><div align="center"><?php echo number_format($rrows['rowtotals']); ?> &nbsp; ( <?php  echo $rrows['curr'] ?>)
             </div></td>
          </tr>
          <?php }?>
		  </tbody>
