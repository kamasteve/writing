...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'slug'               => 'layersliderwp_v.5.1.1', // The plugin slug (typically the folder name).
            'source'             => get_stylesheet_directory() . '/plugins/layersliderwp_v.5.1.1.zip', // The plugin source.
        ...
        array(
            'name'      => 'AddThis Social Bookmarking Widget',
            'slug'      => 'addthis',
            'required'  => false,
        ),
        // This is an example of how to include a plugin from the WordPress Plugin Repository.
        ...
        // This is an example of how to include a plugin from the WordPress Plugin Repository.
        array(
            'name'      => 'WP Dynamic Sidebar',
            'slug'      => 'wp-dynamic-sidebar',
            'required'  => false,
        ),
