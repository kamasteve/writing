...
<table width="100%" border="0">
  <tr valign="top">
    <td><span  style=" text-align: center;" class="titlehdr"><strong>Assigned and Confirmed  Orders</strong></span>
	<br><span style="text-align:center; font-size:15px; font-weight:bold;"> Order(s) in progess... </span>
	</div></td>
    <td width="25%"><div style="float:right;"><?php include 'gmttime.php'; ?></div></td>
  </tr>
</table>
      <?php 
	  $sql_assigned = "select * from orders where status='Cf' and client_id='$_SESSION[id]'";
